...
tree_dir=/work/kaldi/egs/XSP/s5_aishell/exp/xmuspeech/chain/tree
lat_dir=/work/kaldi/egs/XSP/s5_aishell/exp/xmuspeech/tri4b_sp_lats
dir=exp/chain${nnet3_affix}/tdnn${tdnn_affix}_1_workers
...
if [[ $stage -le 21 ]]; then
  ...
  init_method=tcp://127.0.0.1:7274
...
if [[ $stage -le 23 ]]; then
  ...
  utils/mkgraph.sh --self-loop-scale 1.0 data/lang_tgtest $dir $dir/graph
fi
